...
All data in this directory is generated by the main data pipeline script. To regenerate the files for a specific year or for all years, run the following commands from the project root:

```bash
# Regenerate data for a single year
python src/run_pipeline.py --year 2024

# Regenerate data for all available years (2019-2024)
python src/run_pipeline.py --all --overwrite
```
